...
class TestMarsRover:
    ...
    def test_command_forward_returns_0_1_N(self, mars_rover):
        assert mars_rover.execute("M") == "0:1:N"

    def test_command_forward_twice_returns_0_2_N(self, mars_rover):
        assert mars_rover.execute("MM") == "0:2:N"

    def test_command_forward_three_times_returns_0_3_N(self, mars_rover):
